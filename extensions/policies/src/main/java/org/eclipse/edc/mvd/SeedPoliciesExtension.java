...
public class SeedPoliciesExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        policyEngine.registerFunction(CATALOGING_SCOPE, Permission.class, TRUSTED_PARTICIPANTS_EVALUATION_KEY, new TrustedParticipantsWhitelistConstraintFunction());
    }
